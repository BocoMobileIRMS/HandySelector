...
public class MaterialDesignActivity extends AppCompatActivity implements ToolbarManager.OnToolbarGroupChangedListener {
...
//                Toast.makeText(this, "Current theme: " + theme, Toast.LENGTH_SHORT).show();
    ...
    class DrawerAdapter extends BaseAdapter implements View.OnClickListener, ThemeManager.OnThemeChangedListener {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            View v = convertView;
            if (v == null) {
                v = LayoutInflater.from(MaterialDesignActivity.this).inflate(R.layout.row_drawer, null);
