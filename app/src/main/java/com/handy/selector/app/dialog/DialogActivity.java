package com.handy.selector.app.dialog;
...
import com.handy.selector.dialog.adapter.SuperRcvHolder;
import com.handy.selector.dialog.bottomsheet.BottomSheetBean;
import com.handy.selector.dialog.config.ConfigBean;
import com.handy.selector.dialog.interfaces.MyDialogListener;
import com.handy.selector.dialog.interfaces.MyItemDialogListener;
        ...
        switch (view.getId()) {
            ...
            case R.id.btn_common_progress:
                new Thread(new Runnable() {
                    @Override
                    public void run() {
                        StyledDialog.buildLoading("加载中...").setActivity(DialogActivity.this).show();
                    }
                }).run();
                StyledDialog.dismissLoading();
