...
public abstract class SmoothCompoundButton extends android.support.v7.widget.AppCompatButton implements Checkable {
     ...
     **/
    private final int DEFAULT_COLOR_ON = 0xff0091ea;
    /**
     * OFF状态的颜色，appcompat是colorControlNormal=?android:attr/textColorSecondary
     **/
    private final int DEFAULT_COLOR_OFF = 0xff9e9e9e;
    // 这个ATTRS的项必须是从小到大排列的
     ...
     * @param notifyOnCheckedChangeListener 是否回调OnCheckedChangeListener
     */
